...
def create_model(encoder_model_name):
  ...
  #layer2 = layers.Dropout(0.1, name='DroputLayer1')(layer1)
  layer3 = layers.Dense(128, name="DenseLayer2")(layer1)
  #layer4 = layers.Dropout(0.1, name='DroputLayer2')(layer3)

  layer5 = layers.Dense(LABELS_NUM, name="DenseLayer3", activation = "softmax")(layer3)
